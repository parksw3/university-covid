...
simulate_omicron_switch_outbreak <- function(param=drawpar(),
                     vprop=0.99,
                     boostprop=0.65,
                     veff_twodose=0.1,
                     veff_threedose=0.7,
  ...
  func.arg <- list(
    ...
    dateend=dateend,
    dateoutbreak=dateoutbreak,
    dateswitch=dateswitch,
    outbreaksize=outbreaksize,
    thetavec=thetavec,
  ...
  state[!return & state %in% c("E", "Ip1", "Ip2", "Ia1", "Ia2", "Is1", "Is2")] <- "S"
  ...
  simres <- do.call("simulate_internal_omicron_switch_outbreak", func.arg2)
