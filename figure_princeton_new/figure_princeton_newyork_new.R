...
g1 <- ggplot(fall2020) +
  ...
  geom_line(data=nyc_fall2020, aes(date, cases/1000, group=1), col="red") +
  geom_point(data=nyc_fall2020, aes(date, cases/1000), col="red") +
 scale_x_discrete("Date") +
  scale_y_continuous("Princeton cases", expand=c(0, 0), limits=c(0, 50),
                     sec.axis = sec_axis(trans=~.*1000, "New York City cases")) +
...
g2 <- ggplot(spring2020) +
  ...
  geom_line(data=nyc_spring2020, aes(date, cases/1000, group=1), col="red") +
  geom_point(data=nyc_spring2020, aes(date, cases/1000), col="red") +
  scale_x_discrete("Date") +
...
g3 <- ggplot(fall2021) +
  geom_bar(aes(as.factor(date), value, fill=key), stat="identity") +
  geom_line(data=nyc_fall2021, aes(date, cases/1000, group=1), col="red") +
  geom_point(data=nyc_fall2021, aes(date, cases/1000), col="red") +
  scale_x_discrete("Date") +
...
g4 <- ggplot(spring2021) +
  geom_bar(aes(as.factor(date), value, fill=key), stat="identity") +
  geom_line(data=nyc_spring2021, aes(date, cases/1000, group=1), col="red") +
  geom_point(data=nyc_spring2021, aes(date, cases/1000), col="red") +
  scale_x_discrete("Date") +
  scale_y_continuous("Princeton cases", expand=c(0, 0), limits=c(0, 500),
                     sec.axis = sec_axis(trans=~.*1000, "New York City cases")) +
  scale_fill_viridis_d() +
...
ggsave("figure_princeton_correlation_newyork_new2.pdf", gfinal3, width=12, height=10)
