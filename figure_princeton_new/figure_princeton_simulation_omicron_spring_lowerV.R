...
load("../simulation_omicron_spring/simulation_omicron_spring_increase_50_lowerV.rda")
load("../simulation_omicron_spring/simulation_omicron_spring_increase_100_lowerV.rda")

simall_spring_2021_increase_50 <- lapply(simulation_omicron_spring_increase_50_lowerV, function(x){
  lapply(x, function(y) {
    data.frame(
      date=y$datevec,
...
simall_spring_2021_increase_100 <- lapply(simulation_omicron_spring_increase_100_lowerV, function(x){
  lapply(x, function(y) {
    data.frame(
      date=y$datevec,
      time=1:length(y$incidencevec),
...
ggsave("figure_princeton_simulation_omicron_spring_lowerV.pdf", g1, width=12, height=8)
