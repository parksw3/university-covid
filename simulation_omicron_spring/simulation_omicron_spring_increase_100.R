...
simulation_omicron_spring_increase_100 <- vector('list')
...
for (j in 1:nrow(paramvec)) {
  ...
  simulation_omicron_spring_increase_100[[j]] <- tmplist
}

save("simulation_omicron_spring_increase_100", file="simulation_omicron_spring_increase_100.rda")
