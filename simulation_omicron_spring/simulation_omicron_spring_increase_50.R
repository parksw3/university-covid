...
simulation_omicron_spring_increase_50 <- vector('list')
...
for (j in 1:nrow(paramvec)) {
  ...
  simulation_omicron_spring_increase_50[[j]] <- tmplist
}

save("simulation_omicron_spring_increase_50", file="simulation_omicron_spring_increase_50.rda")
