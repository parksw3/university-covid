...
simulation_omicron_spring_increase_50_shortI <- vector('list')
...
for (j in 1:nrow(paramvec)) {
  ...
  simulation_omicron_spring_increase_50_shortI[[j]] <- tmplist
}

save("simulation_omicron_spring_increase_50_shortI", file="simulation_omicron_spring_increase_50_shortI.rda")
