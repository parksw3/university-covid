...
simulation_omicron_spring_increase_20 <- vector('list')
...
for (j in 1:nrow(paramvec)) {
  ...
  simulation_omicron_spring_increase_20[[j]] <- tmplist
}

save("simulation_omicron_spring_increase_20", file="simulation_omicron_spring_increase_20.rda")
