...
simulation_omicron_spring_increase_50_lowerV <- vector('list')
...
for (j in 1:nrow(paramvec)) {
  ...
  simulation_omicron_spring_increase_50_lowerV[[j]] <- tmplist
}

save("simulation_omicron_spring_increase_50_lowerV", file="simulation_omicron_spring_increase_50_lowerV.rda")
