...
simulation_omicron_spring_increase_10 <- vector('list')
...
for (j in 1:nrow(paramvec)) {
  ...
  simulation_omicron_spring_increase_10[[j]] <- tmplist
}

save("simulation_omicron_spring_increase_10", file="simulation_omicron_spring_increase_10.rda")
