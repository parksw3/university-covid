...
Irini Daskalaki\textsuperscript{?}
Robin M. Izzo\textsuperscript{?}
C. Jessica E. Metcalf\textsuperscript{1}
Daniel A. Notterman\textsuperscript{?}
...
Finally, we find that a super-spreading event likely played a major role in driving the recent outbreak on the Princeton University campus during the spring semester of a 2021--2022 academic year.
Despite large numbers of cases on campus, case levels in surrounding communities remained low, suggesting that there was little spillover transmission from campus to the local community.
...
The development of vaccines has provided a safe means of reopening society, but uncertainty remains in their long-term effectiveness in preventing infection and transmission, especially in the face of new viral variants.
...
Here, we focused on the dynamics of SARS-CoV-2 on the PU campus alone to eliminate heterogeneities inherent to such comparisons.

We analyzed the spread of SARS-CoV-2 on campus (\fref{princeton}).
We begin with a descriptive analysis of the outbreak and then present modeling analyses of the various outbreaks during 2020--2022.
...
For the fall semester of the 2021--2022 academic year, all students and faculty and staff members were required to be vaccinated, with very few medical and religious exemptions.
...
\subsection{Comparison with community transmission}
...
however, we note that this ratio needs to be interpreted with caution as it is sensitive to changes in testing patterns as well as the numbers of students on campus.
...
Second, the safe reopening of a university campus must consider the spread of SARS-CoV-2 within the surrounding community as they can both potentially drive transmission in each other---however, the degree to which infections spread from campus to community remains uncertain.
